...
const TimelineCard = ({ year, title, description, accent }: TimelineItem) => {
  return (
    <div className="flex-col items-center justify-center rounded-xl bg-(--color-card-bg) w-85 h-60 border-2 border-black border-solid font-(--font-primary) text-(--color-text)">
